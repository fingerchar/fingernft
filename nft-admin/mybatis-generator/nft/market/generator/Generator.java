...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://16.162.202.33:3306/matic-market?useUnicode=true&useSSL=false&characterEncoding=utf8");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("matic-market");
        dsc.setPassword("c4P4kFpmbLShAxjH");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setModuleName("");
        pc.setParent("nft.market");
        pc.setEntity("domain");
        pc.setMapper("dao");
        ...
        // 调整 mapper生成目录
        /*focList.add(new FileOutConfig("/mybatis-generator/mapper.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                //输出的位置
            	return projectPath + "/src/main/java/com/" + pc.getModuleName()
        ...
        // 调整 domain生成目录
        focList.add(new FileOutConfig("/mybatis-generator/entity.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                //输出的位置
            	return projectPath + "/src/main/java/com/" + pc.getModuleName()
...
//class MySqlTypeConvertCustom extends MySqlTypeConvert implements ITypeConvert {
	...
	public IColumnType processTypeConvert(GlobalConfig globalConfig, TableField tableField) {
		if(tableField.getColumnName().toLowerCase().equals("role_ids")) {
			return DbColumnType.
		}
