...
import com.fingerchar.service.FcStorageService;
...
public class AdminStorageController  extends BaseController {
    ...
    public Object create(@RequestParam("file") MultipartFile file, String flag) throws IOException {
        ...
        FcStorage fcAdminStorage = storageService.store(file.getInputStream(), file.getSize(), file.getContentType(), originalFilename, flag);
