...
public class AdminResponseCode {
    ...
    public static final Integer ADMIN_NAME_EXIST = 600;
    ...
    public static final Integer ADMIN_INVALID_ACCOUNT_LOCKED = 608;
    public static final Integer ADMIN_INVALID_ACCOUNT_FAILED = 609;
